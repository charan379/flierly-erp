...
// Define a type for the result object, which will be the transformed query
type TransformedQuery = Record<string, any>

/**
 * Reverse transforms a query object to its original values.
 *
 * @param {Query} query - The query object to be transformed.
 * @returns {TransformedQuery} - The transformed query object with original values.
 */
const reverseTransformQuery = (query: Query): TransformedQuery | undefined => {
