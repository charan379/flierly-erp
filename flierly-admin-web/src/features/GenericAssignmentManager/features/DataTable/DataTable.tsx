...
interface DataTableProps<T> extends Omit<ProTableProps<T, any>, "rowKey" | "size" | "options" | "tableAlertRender" | "style" | "pagination" | "search" | "scroll" | "showSorterTooltip" | 'bordered'> {
    id: string
}
