...
function useTheme() {
    ...
    const getSysPreference = (): boolean =>
    ...
    return {
        ...
        setThemePreference: (newPreference: ThemePreference) =>
            dispatch(CHANGE_THEME_PREFERENCE(newPreference)), // Function to change theme preference
    };
}
