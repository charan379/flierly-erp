 ...
 *
 * @param {Record<string, string>} translation - The translation object containing key-value pairs of translations.
 ...
 */
export default function getTranslation(translation: Record<string, string>, key: string): string {
  try {
    ...
    if (Object.prototype.hasOwnProperty.call(translation, lowerCaseKey)) {
