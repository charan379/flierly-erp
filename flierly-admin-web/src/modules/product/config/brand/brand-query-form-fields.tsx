...
const brandQueryFormFields: QueryFieldConfig<Brand>[] = [
  // id
  {
  ...
  // name
  {
    field: { label: 'Brand Name', namePath: 'name' },
    conditions: [
      {
        condition: { label: 'Equals to', namePath: 'equalTo' },
  ...
  // isActive
  {
    field: { label: 'Brand Status', namePath: 'isActive' },
    conditions: [
      {
...
export default brandQueryFormFields
