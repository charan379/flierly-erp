...
import { createBooleanFormField, createEmailFormField, createMobileFormField } from '@/utils/create-dynamic-formfield'

const createUserAddFormFields = (): FormFieldConfig<User>[] => {
  ...
  return [
    ...
    // email
    createEmailFormField({ access: { permission: /^user\.update$/, ifNoAccess: 'disable' }, entity: 'user' }),
    // mobile
    createMobileFormField({ access: { permission: /^user\.update$/, ifNoAccess: 'disable' }, entity: 'user' }),
    // isActive
...
export default createUserAddFormFields
