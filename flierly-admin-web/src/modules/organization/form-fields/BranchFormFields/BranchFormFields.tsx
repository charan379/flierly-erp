...
export interface BranchFormFieldsProps {
    formInstance?: FormInstance<Branch>;
    isEditForm?: boolean;
    disabledFields?: Array<keyof Branch>
}
const BranchFormFields: React.FC<BranchFormFieldsProps> = ({ disabledFields, formInstance: _, isEditForm }) => {
    ...
    return (
        <>
            ...
            <ProFormText
                ...
                disabled={(isEditForm && !hasPermission(pr('branch.update'))) || disabledFields?.includes('name')}
            />
            ...
            <ProFormTextArea
                ...
                disabled={(isEditForm && !hasPermission(pr('branch.update'))) || disabledFields?.includes('description')}
            />
        </>
    )
};
