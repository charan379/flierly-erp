 ...
 */
const getDiffFromArrayOfNumbers = (existingArray: (number | string)[], newArray: (number | string)[]): { newEntries: number[]; removedEntries: number[] } => {
...
export default getDiffFromArrayOfNumbers;
